...
function getEmployeesWithGreaterSalary(employees, n) {
  let filteredEmployees = employees.filter((item) => item.salary.slice(1) > n);
  return filteredEmployees;
}
console.log(getEmployeesWithGreaterSalary(employees, 1200));
