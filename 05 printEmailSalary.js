...
function printEmailSalary(collection) {
  emailSalary = collection.map((item) => [
    `${" " + item.email + " " + item.salary}`,
  ]);
  return emailSalary.join(",");
}

console.log(printEmailSalary(employees));
